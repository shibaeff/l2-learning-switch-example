...
static void setPortChain(std::string dpid, std::string mac, uint32_t inport);
// std::string BASIC_STRING = "http://localhost:1317/runos_chain/configstore/hosts_database/";
